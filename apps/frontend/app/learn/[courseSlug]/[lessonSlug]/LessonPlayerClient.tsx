...
import type { CourseDetail, LessonDetail, LessonSummary, Media } from "@/types";
...
export default function LessonPlayerClient({
    ...
    // Get YouTube ID or use demo
    const youtubeId = videoMedia?.url
        ? extractYouTubeId(videoMedia.url)
        : DEMO_YOUTUBE_IDS[currentIndex % DEMO_YOUTUBE_IDS.length];
    ...
    useEffect(() => {
        const checkAccess = async () => {
            ...
            try {
                ...
                if (!data.enrolled && !lesson.isFree) {
        ...
        checkAccess();
    }, [isAuthenticated, course.id, course.slug, lesson.isFree, router]);
                        ...
                        <div className="h-full overflow-y-auto">
                            ...
                            <div className="p-2">
                                {allLessons.map((l, index) => {
                                    ...
                                    // Demo: first few lessons are completed
