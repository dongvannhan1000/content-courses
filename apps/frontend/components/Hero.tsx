    ...
    return (
        <section className="relative py-20 px-4 overflow-hidden">
            ...
            <div className="absolute inset-0 -z-10">
                ...
                <div className="absolute top-40 right-10 w-72 h-72 bg-accent-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse" style={{ animationDelay: "1s" }}></div>
                <div className="absolute bottom-20 left-1/2 w-72 h-72 bg-primary-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: "2s" }}></div>
            </div>
            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6">
                        ...
                        <h1 className="font-display font-bold text-5xl md:text-6xl text-gray-900 leading-tight">
                            Làm chủ
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <button className="px-8 py-4 glass text-gray-700 font-semibold rounded-xl hover:shadow-xl transition-all duration-200 flex items-center gap-2 cursor-pointer">
                        ...
                        <div className="grid grid-cols-3 gap-6 pt-8">
                            <div>
                                <div className="text-3xl font-bold text-primary-700">20K+</div>
